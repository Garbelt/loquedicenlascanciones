...

{
    ...
    autor:"FUERZA REGINA & GRUPO FRONTERA",

    audio:"audios/COQUETA.mp3",

    letra:`PENSANDO Y VIENDO LAS ESTRELLAS, PREGUNTÉ
...
PA' SENTIRNOS ETERNOS COMO LA ÚLTIMA VEZ.
QUIERO CONFESARTE, TE EXTRAÑO,
COMO UN LOCO, TE PIENSO, YO SÉ QUE TÚ TAMBIÉN.

PORFA, MA, YA VUELVE CONMIGO,
PERO NO COMO AMIGOS COMO LA ÚLTIMA VEZ.
QUIERO CONFESARTE, TE EXTRAÑO,
COMO UN LOCO, TE PIENSO, YO SÉ QUE TÚ TAMBIÉN.
...
DE MI CEL AHÍ TE VA LA CLAVE,
QUE YO NO HABLO CON NADIE, NOMÁS CONTIGO.

ES QUE ME MATA EL RECUERDO
Y SOLO PIENSO QUE PIENSO,
QUE TE QUITES LOS DOLCE & GABBANA.
YO SOLO SIENTO QUE SIENTO,
QUE NO SÉ QUÉ ES LO QUE SIENTO,
TANTO NOS PASÓ EN UNA SEMANA.

YA BLOQUÉAME SI NO ES CIERTO,
PERO YO SÉ, BABY CIERTO
QUE AMBOS, MAMI, NOS TENÍAMOS GANAS.
PUEDE QUE SÍ, RECONOZCO,
...

{
    ...
    autor:"CALLEJERO FINO",

    audio:"audios/NO LES DA.mp3",

    letra:`VOS PENSÁS NOMÁS QUE LA GUACHA ES TUYA.
SI HABILITA, ES GOL.
HAGAN CASO.
CON LEA IN THE MIX.
ESTO ES PA' QUE ROMPA LA BOCINA, VO' SABÉ’,

SI NO LE DOY PERREO, ELLA SE ARISCA, CA-CA, CA-CA
SI NO LE DOY PERREO, PERREO.

ELLA CASI SIEMPRE ES CALLADITA
PERO NO SABE NADIE QUE ES POR CULPA DE LA ALITA.
AHORA QUE ESTÁ SOLTERA, ELLA SE PUSO MÁS BONITA
Y COMO LA .22, GRITA Y PATEA LA CHIQUITA.
CON, SIN O CON, YO TE LO PONGO,
RON, ESTOY EN ON, MOVÉ EL MONDONGO.
PERDÓN, SALTÉ EL PAREDÓN, ENCARÉ PA'L FONDO
YO TENGO PISTOLA, YO NO COMPRO CON TAЕKWONDO.

DALE, MA, QUE LOS TURRO' SIEMPRЕ ESTAMOS CHETO MAL.
'TA DOLIDO DESDE QUE SAQUÉ "PA TRA"…
SE TIRAN ENTRE ELLOS, PORQUE CONTRA MÍ NO LES DA.

BANCAME QUE ME TOMO OTRA…

DALE, MA, QUE LOS TURRO' SIEMPRE ESTAMOS CHETO MAL
ESTABAN ESPERANDO EL MOMENTO 'E QUE YO LLEGARA.
ACÁ ESTOY, PA' LOS QUE DICEN QUE DISPARAN
Y SOBRAN BALAS PARA TU CARA.
SE PONE CARIÑOSA CUANDO LE DA AL POLVO ROSA,
PELINEGRA PELIGROSO, SE FUMA UNA MARIPOSA,
TE TRAJE UNA COSA SABROSA, MARAVILLOSA,
HOY TE ROMPO LA MIMOSA, GOLOSA.
...
{
    titulo:"SI ESTÁS CON ALGUIEN",

    autor:"OMAR COURTZ",

    audio:"audios/SI ESTÁS CON ALGUIEN.mp3",

    letra:`YO ME ACUERDO AQUEL DÍA, TÚ Y YO, TÚ ENCIMA.
DOS CUERPO' A ESCONDIDA', BEBÉ, LA NOCHE ERA DE LOS DO'.
¿DÓNDE ESTÁS METÍ'A? DE LA DISCO, SALE DE DÍA…
OJALÁ QUE TE ACUERDES, MI AMOR.

PA' HACERLO HOY, HOY,
MI AMOR, YEAH-YEAH, EY.

SI ESTÁS CON ALGUIEN, DILE QUE TÚ ERE' MÍA,
QUE NO SOMOS NÁ', PERO QUE NO ME OLVIDAS, MI AMOR.

4 A.M., LOCA CON EL NENE,
NOTA LOS WEEKENE', YO NO SÉ QUÉ ELLA TIENE,
PERO TIENE LO QUE ME GUSTA, PA' SU CASA ES LA RUTA.
BABY, TÚ ERES MI MUSA, CALIENTE COMO UNA HOOKAH.

SALIENDO DE DÍA, COMO A LAS 6 DE LA MORNING,
DICE QUE SE DESVÍA, PERO QUE NÁ' MÁ' ESO ES POR MÍ.
DICE QUE ESTA ES SU PRIMERA VE'
Y YO SÉ QUE ESTA NO ES SU PRIMERA VE'.

EY, YO ME SÉ TO' LOS PUNTO',
TO' LOS FETICHES SE LOS CUMPLO,
COMO UNA BROCHA, SE LO PASO
COMO SI NO HAY MÁS NADIE EN ESTE MUNDO.

YO NUNCA LE DIGO: DETENTE,
ELLA ES COMO UNA SERPIENTE,
PERO ES DE ESAS VENENOSA',
LE GUSTA JUGAR CON MI MENTE.

YO SÉ QUE TE GUSTA CUANDO HACEMO' EL AMOR,
MAMI, TÚ TE FUISTE, PERO SE QUEDÓ TU OLOR.
MÍA POR SIEMPRE, PERO LEJO' ESTAMO' MEJOR,
SI TÚ QUIERE', YO TE HAGO EL FAVOR.
...
(QUÉ OUSI, NI QUÉ OUSI.
A MÍ TÚ ME HABLA' DE OMAR.
ESTE OMARCITO QUE ESTÁ ACÁ,
NO ES EL MISMO.
NO ES EL MISMO QUE YO CONOCÍ
Y NO ME ENCANTA.
ASÍ QUE SI NO VA A ESTAR
EL QUE YO CONOCÍ AL PRINCIPIO
NO LO QUIERO.
YO CREO QUE YA…
YA, YO ME RINDO).
`,
